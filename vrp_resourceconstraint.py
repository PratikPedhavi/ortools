''' VEHICLE ROUTING PROBLEM WITH RESOURCE CONSTRAINT '''
...
def print_solution(data, manager, routing, solution):
    ...
    for vehicle_id in range(data['num_vehicles']):
        ...
        while not routing.IsEnd(index):
            ...
            plan_output += '{} Time ({},{}) -> '.format(manager.IndexToNode(index), solution.Min(time_var), solution.Max(time_var))
    ...
    print('Total time of all routes: {}mins \n'.format(total_time))
